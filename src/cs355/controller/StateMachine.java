...
public class StateMachine
{
	...
	private void createNewLine(Point2D mouseLoc)
	{
		...
		{
			setCurrentShape((Shape) new Line(getCurrentColor(), (Point2D.Double) clickLocations.get(0),
	...
	private void createNewTriangle(Point2D mouseLoc) throws IOException
	{
		...
		setCurrentShape((Shape) new Triangle(getCurrentColor(), null, (Double) clickLocations.get(0),
