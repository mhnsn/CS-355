...
public class CurrentCameraState
{
	...
	public void dump()
	{
		...
		System.out.println("====================");
		System.out.println(GUIViewRefresher.clippedLines.size());
		System.out.println(dumpLines(GUIViewRefresher.clippedLines));

	}
	
	private String dumpLines(ArrayList<Line3D> clippedLines)
	{
		StringBuilder sb = new StringBuilder();
		try
		{
			
			for (Line3D l : clippedLines)
			{
