...
public class LineVector3D
{
	...
	public LineVector3D(Line3D l)
	{
		...
		end = new Point3D(l.end.x, l.end.y, l.end.z);
		origin = new Point3D(l.start.x, l.start.y, l.start.z);
	...
	// * @return
	// */
	// public boolean rotate(double xAxis, double yAxis, double zAxis, boolean
	// useRadians)
	// {
	// double[][] newV = Transform3D.rotate(this, xAxis, yAxis, zAxis,
	// useRadians);
	// double[][] newP = Transform3D.rotate(this, xAxis, yAxis, zAxis,
	// useRadians);
	//
	// x = newV[0];
	// y = newV[1];
	...
	// *
	// * @param c
	// * @return true if this is a line and was scaled; false if this is a
	// vector
	// */
	...
	{
		String rVal = "Origin: " + origin.toString() + "\r\n\tVector: [X: " + x + ", Y: " + y + ", Z:" + z + ", W:" + w
				+ "]\r\n" + "\r\nEnd: " + end.toString() + "\r\n\toW = " + oW;
