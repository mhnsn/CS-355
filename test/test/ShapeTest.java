...
public class ShapeTest {
	...
	public static void setUpBeforeClass() throws Exception
	{
		...
		T = new Triangle	(Color.WHITE, new Point2D.Double(233.33333, 233.33333),
	...
	public final void testPointInShapeSquare()
	{
		for(int x = 150; x < 250; x += 10)
		{
			...
			{
				assertEquals(true, S.pointInShape(new Point2D.Double(x, y), 0));
			}
		}		
	}
	...
	public final void testPointInShapeRectangle()
	{
		for(int x = 150; x < 250; x += 10)
		{
			for(int y = 150; y < 250; y += 10)
			{
				assertEquals(true, R.pointInShape(new Point2D.Double(x, y), 0));
			}
		}		
	}
	...
	public final void testPointInShapeCircle()
	{
		for(int x = 150; x < 250; x += 10)
		{
			for(int y = 150; y < 250; y += 10)
			{
				...
				{
					assertEquals(true, C.pointInShape(new Point2D.Double(x, y), 0));
				}
			}
		}		
	}
	...
	public final void testPointInShapeEllipse()
	{
		for(int x = 150; x < 250; x += 10)
		{
			for(int y = 150; y < 250; y += 10)
			{
				if(((200-x)*(200-x) + (200-y)*(200-y)) <= 10000)
				{
					assertEquals(true, E.pointInShape(new Point2D.Double(x, y), 0));
				}
			}
		}		
	}
	...
	public final void testPointInShapeTriangle()
	{
		for(int x = 150; x < 250; x += 10)
		{
			for(int y = 150; y < 250; y += 10)
			{
				...
				{
					assertEquals(true, T.pointInShape(new Point2D.Double(x, y), 0));
				}
			}
		}
		
		T = new Triangle	(Color.WHITE, new Point2D.Double(362.66667, 233.66667),
										  new Point2D.Double(378, 34),
										  new Point2D.Double(232, 273),
										  new Point2D.Double(478, 394));
		
		assertEquals(true, T.pointInShape(new Point2D.Double(362.66667, 233.66667), 0));
	}
